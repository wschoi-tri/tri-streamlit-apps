...
st.set_page_config(
    page_title="검색 키워드 트렌드 추천 서비스 확인",
    layout="wide",
...
def load_keywords():
    ...
    if os.path.exists(kw_path):
        try:
            ...
            pass
    return [
        "가디건", "골프모자", "골프백", "골프티", "골프화", "긴바지", "긴팔티셔츠", "남성가방", "남성골프화", "니트",
        "데님팬츠", "드레스", "런닝화", "레인부츠", "로퍼", "맨투맨", "머플러", "모자", "목걸이", "민소매",
        "민소매티셔츠", "반바지", "반팔", "반팔티셔츠", "베스트", "벨트", "볼캡", "부츠", "샌들", "셔츠",
        "숄더백", "스니커즈", "스커트", "슬랙스", "슬리퍼", "슬링백", "신발", "아우터", "여성가방", "여성골프화",
        "여성벨트", "오픈토", "운동화", "원피스", "자켓", "바람막이", "점퍼", "조끼", "집업", "집업티셔츠",
        "코트", "크로스백", "토트백", "트렌치", "티셔츠", "패딩", "팔찌", "팬츠", "펌프스", "플랫",
        "하프팬츠", "후드", "후리스", "후드티", "스웨터", "블라우스", "슈즈", "무스탕"
    ]
